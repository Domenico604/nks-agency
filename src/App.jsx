...
const translations = {
  ...
  en: {
    ...
    testimonials: [
      ...
      { name: "David", role: "EdTech Platform", text: "We needed strong brand awareness. NKS Vector took over everything: from topic research to final sound design. CPA dropped to a third.", img: "/Pic 13.png" },
